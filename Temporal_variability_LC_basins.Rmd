...
#  ndim= number of dimension for PCA, default is 5
mpca <- function(mstationID, ndim=5)
{
  ...
  acpR<-dudi.pca(mdata[,-c(1,2)])
  ndim
  summary(acpR)
  s.corcircle(acpR$co, clab=0.8)
  s.label(acpR$l1, clabel=0.6, label = mdata$VisitDate)
