...
LTcond <- read.delim("/Volumes/-/Script R/LCM_GitHub_Data_LCM/data_from_Pascal/LT_ConditionOverall.txt")
```
...
# Read data
# target catch
tg16 <- read.delim("/Volumes/-/Script R/LCM_GitHub_Data_LCM/data_from_Pascal/LT_2016_targetcatch.txt");tg16$notes <- rep(NA, nrow(tg16))
tg17 <- read.delim("/Volumes/-/Script R/LCM_GitHub_Data_LCM/data_from_Pascal/LT_2017_targetcatch.txt")
tg18 <- read.delim("/Volumes/-/Script R/LCM_GitHub_Data_LCM/data_from_Pascal/LT_2018_targetcatch.txt")
# bycatch
byc16 <- read.delim("/Volumes/-/Script R/LCM_GitHub_Data_LCM/data_from_Pascal/LT_2016_bycatch.txt")
byc17 <- read.delim("/Volumes/-/Script R/LCM_GitHub_Data_LCM/data_from_Pascal/LT_2017_bycatch.txt")
byc18 <- read.delim("/Volumes/-/Script R/LCM_GitHub_Data_LCM/data_from_Pascal/LT_2018_bycatch.txt")
...
```{r message=FALSE, warning=FALSE, include=FALSE}
LTdiet <- read.delim("/Volumes/-/Script R/LCM_GitHub_Data_LCM/data_from_Pascal/LT_diet_2016-2018.txt")
