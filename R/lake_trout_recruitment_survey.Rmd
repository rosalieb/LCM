...
p <- levelplot(bathy2, 
          ...
          at=seq(-130, 0, len=101)) # colour ramp breaks

p

# pdf(paste0(getwd(),"/Output/Figures/1-descriptive/LC_bathy.pdf"),width = 4, height = 9)
# p
# dev.off()
...
p5 <- grid.arrange(p3, p4, ncol=2, widths=c(2,4))
p5
