...
Smelt map 
```{r smelt map}
col=colorspace::diverge_hsv(5, s = .8)

pdf(paste0(getwd(),"/Output/Figures/9-Smelt/Smelt_sampling_sites.pdf"),width = 6, height = 9)
png(paste0(getwd(),"/Output/Figures/9-Smelt/Smelt_sampling_sites.png"),width = 4, height = 9)
plot(DEM, col=col, main="") 
...
legend("topleft", legend = c("Main Lake", "Malletts Bay", "Northeastern Arm"), pch= c(16,15,17), bty="n")
