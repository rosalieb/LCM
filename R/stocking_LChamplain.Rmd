...
```{r include=FALSE}
stkvt <- read.delim('/Volumes/-/Script R/LCM_GitHub_Data_LCM/Stocking/VTFWD_Stocking_2009-2019.txt')
nrow(stkvt)
...
bathy<-readOGR("/Users/Rosalie/Desktop/Travail/QGIS/LakeChamplainBathy/LakeChamplain_Shapefile/LakeChamplain.shp")
...
gps1 <- read.delim("/Volumes/-/Script R/LCM_GitHub_Data_LCM/Stocking/GPS_coordinates_stocking_locations_counties.txt")
...
gps2 <- read.delim("/Volumes/-/Script R/LCM_GitHub_Data_LCM/Stocking/GPS_coordinates_stocking_locations_LC.txt")
gps2_df <- gps2
...
```{r include=FALSE}
stkny <- read.delim('/Volumes/-/Script R/LCM_GitHub_Data_LCM/Stocking/NYDEC_Stocking_2011-2019.txt')
nrow(stkny)
names(stkny)
