...
groups <- c('Sea Lamprey', 'Adult lake trout', 'Juvenile lake trout', 'Atlantic salmon', 'Burbot', 'Walleye', 'Whitefish', 'Cisco', 'Smelt', 'Alewife', 'Trout-perch', 'Sculpin', 'Zoo predators', 'Mysis', 'Benthic invertebrates', 'Zoo grazers', 'Phytoplankton', 'Detritus','Fleet1')
...
stgroups <- c(rep(NA, 1), rep('LakeTrout', 2), rep(NA, 15),NA)
...
REco.params.LC$model[Group %in% c('Sea Lamprey'), Biomass := M_fish$sea_lamprey]
REco.params.LC$model[Group %in% c('Adult lake trout'), Biomass := M_fish$lake_trout_ad]
REco.params.LC$model[Group %in% c('Juvenile lake trout'), PBiomassB := M_fish$lake_trout_juv]
REco.params.LC$model[Group %in% c('Atlantic salmon'), Biomass := M_fish$atlantic_salmon]
REco.params.LC$model[Group %in% c('Burbot'), Biomass := M_fish$burbot]
REco.params.LC$model[Group %in% c('Walleye'), Biomass := M_fish$walleye]
REco.params.LC$model[Group %in% c('Whitefish'), Biomass := M_fish$whitefish]
REco.params.LC$model[Group %in% c('Cisco'), Biomass := M_fish$cisco]
REco.params.LC$model[Group %in% c('Smelt'), Biomass := M_fish$smelt]
REco.params.LC$model[Group %in% c('Alewife'), Biomass := M_fish$alewife]
REco.params.LC$model[Group %in% c('Trout-perch'), Biomass := M_fish$trout_perch]
REco.params.LC$model[Group %in% c('Sculpin'), Biomass := M_fish$sculpin]
REco.params.LC$model[Group %in% c('Benthic invertebrates'), Biomass := 3]
REco.params.LC$model[Group %in% c('Zoo predators'), Biomass := 13]
REco.params.LC$model[Group %in% c('Zoo grazers'), Biomass := 13]
REco.params.LC$model[Group %in% c('Mysis'), Biomass := 3]
REco.params.LC$model[Group %in% c('Phytoplankton'), Biomass := 300]
...
REco.params.LC$model[Group %in% c('Juvenile lake trout'), PB := M_fish$lake_trout_juv]
...
REco.params.LC$model[Group %in% c('Zoo predators'), PB := 13]
...
REco.params.LC$model[Group %in% c('Zoo predators'), QB := 200]
...
REco.params.LC$model$EE <- rep(0.8, length(REco.params.LC$model$EE))
...
```{r}
# Landing
REco.params.LC$model[, Fleet1 := rep(0, nrow(REco.params.LC$model))]
...
REco.params.LC$stanzas$stgroups[, Wmat     := c(1.2/32)] # weight at maturity / max weight? 

#Individual stanza parameters
REco.params.LC$stanzas$stindiv[, First   := c(0,24)]
REco.params.LC$stanzas$stindiv[,  Last    := c(23,400)]
REco.params.LC$stanzas$stindiv[,  Z       := c(M_fish$lake_trout_juv,
                                               M_fish$lake_trout_ad)]
REco.params.LC$stanzas$stindiv[,  Leading := c(FALSE, TRUE)]
...
```{r}
stanzaplot(REco.params.LC, StanzaGroup = 1)
# black: pop biomass
# green: number
...
REco.params.LC$diet[Group == 'Zoo predators', 'Juvenile lake trout' := 0.05]
...
REco.params.LC$diet[Group == 'Zoo predators', 'Walleye' := 0.1]
REco.params.LC$diet[Group == 'Zoo grazers', 'Walleye' := 0.15]

# Whitefish
REco.params.LC$diet[Group == 'Smelt', 'Whitefish' := 0.2]
REco.params.LC$diet[Group == 'Zoo predators', 'Whitefish' := 0.3]
...
REco.params.LC$diet[Group == 'Zoo predators', 'Cisco' := 0.2]
REco.params.LC$diet[Group == 'Benthic invertebrates', 'Cisco' := 0.2]

# Smelt
REco.params.LC$diet[Group == 'Zoo grazers', 'Smelt' := 0.7]
REco.params.LC$diet[Group == 'Zoo predators', 'Smelt' := 0.3]

# Alewife
REco.params.LC$diet[Group == 'Zoo grazers', 'Alewife' := 0.7]
REco.params.LC$diet[Group == 'Zoo predators', 'Alewife' := 0.3]

# Trout-perch
REco.params.LC$diet[Group == 'Benthic invertebrates', 'Trout-perch' := 0.3]
REco.params.LC$diet[Group == 'Zoo predators', 'Trout-perch' := 0.4]
REco.params.LC$diet[Group == 'Zoo grazers', 'Trout-perch' := 0.3]

# Sculpin
REco.params.LC$diet[Group == 'Mysis', 'Alewife' := 0.5]
REco.params.LC$diet[Group == 'Benthic invertebrates', 'Alewife' := 0.5]

# Zoo predators
REco.params.LC$diet[Group == 'Zoo grazers', 'Zoo predators' := 1]

# Mysis
REco.params.LC$diet[Group == 'Zoo predators', 'Mysis' := 0.1]
...
```{r}
REco <- rpath(REco.params.LC, eco.name = 'Lake Champlain')
REco
```
