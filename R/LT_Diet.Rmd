...
<span style="color:red">Note from Rosalie: clip location gives an info on age, so you're computing the same plot here.</span>
...
<span style="color:red">Note from Rosalie: Stocked LT are stocked larger than their counterparts born in the lake (they had access to higher food quality). But Pascal's research shows that they then lose condition over the season. No needs to change anything here, just some backup info for you.</span>
...
Here, I'm creating a bar chart of the proportion of empty stomachs size classes of lake trout. It appears that the likelihood of finding a trout with an empty stomach is more likely in <span style="color:red">larger</span> fish. 

<span style="color:red">Note from Rosalie: Is it a sampling bias? Larger fish with empty stomachs are not fast enough to avoid the trawl?</span>
...
I've done that below, and the wild fish actually have a better condition than the stocked fish, for the size class 150-250. </span>
