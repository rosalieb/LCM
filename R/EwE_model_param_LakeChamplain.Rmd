...
357/(258+357) # data can be crossed in 58% of the cases
smelt_trawl$match_bio_data <- smelt_trawl$Trawl.No. %in% smelt$Sample.No.
...
# head(smelt_trawl)
# ggplot(smelt_trawl, aes(Year, log(CPUE))) +
#   geom_point(smelt_trawl, mapping = aes(color = match_bio_data)) +
#   facet_wrap(~ Basin) 
...
p1 <- 
  ggplot(smelt_tot_stats[smelt_tot_stats$variable!="mean_w",], aes(Year, value, color = match_bio_data)) +
  scale_color_manual(values=c("TRUE" = "black", "FALSE" = "#1A85FF")) +
    geom_point(data = changepoint_found_out[changepoint_found_out$variable!="mean_w",], 
...
#ggsave(paste0(getwd(),"/Output/Figures/9-Smelt/Final_figure_summary.png"), width = 7, height=9.5)
