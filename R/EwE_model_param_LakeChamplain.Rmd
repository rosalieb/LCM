...
smelt_tot_stats_mean$BasinYear <- paste(smelt_tot_stats_mean$Basin, smelt_tot_stats_mean$Year, collapse = "_")
changepoint_found_out$BasinYear <- paste(changepoint_found_out$Basin, changepoint_found_out$Year, collapse = "_")
data.frame(changepoint_found_out, 
           Cpt1_value = 
             smelt_tot_stats_mean[match(changepoint_found_out$BasinYear, smelt_tot_stats_mean$BasinYear), "value"])
...
ggplot(smelt_tot_stats, aes(Year, value)) +
  ...
  # geom_vline(xintercept = 2003, lty=2) +
  geom_vline(xintercept = 2008, lty=2) +
