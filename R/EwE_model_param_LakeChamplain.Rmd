...
if(!R_U_KNITTING) pdf(paste0(getwd(),"/Output/Figures/5-Summary/summary_biomass2.pdf"),width = 12, height = 6)
...
(M_lake_trout_ad = getM(Lasympt = 150, K = 0.05, Tenv = Tenv))
(M_lake_trout_juv = getM(Lasympt = 23, K = 0.25, Tenv = Tenv))
...
(QB_atlantic_salmon = getQB(Wasympt = 35, Tk=Tk, A = , h =0, d =0))
(QB_burbot = getQB(Wasympt = 34, Tk=Tk, A = 0.73, h = 0, d = 0))
(QB_cisco = getQB(Wasympt = 3.6, Tk=Tk, A = , h = 0, d = 0))
(QB_whitefish = getQB(Wasympt = 19, Tk=Tk, A = , h = 0, d = 0))
(QB_trout_perch = getQB(Wasympt = .058, Tk=Tk, A = , h = 0, d = 0))
(QB_alewife = getQB(Wasympt = 0.2, Tk=Tk, A = , h = 0, d = 0))
(QB_smelt = getQB(Wasympt = 0.363, Tk=Tk, A = , h = 0, d = 0))
(QB_sculpin = getQB(Wasympt = 0.029, Tk=Tk, A = , h = 0, d = 0))
