...
length(tps$tote..fullness.[!is.na(tps$est_number)])
length(tps$tote..fullness.[is.na(tps$est_number)])
...
__Data:__ 
<br>
The data was provided by Ellen Marsden. It contains 24,982 observations of smelt. Each row has some metadata associated (date and basin sampled) as well as individuals characteristics (length, weight, year class, condition).
