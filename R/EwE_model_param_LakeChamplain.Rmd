...
RelCond_Fisheries <- function(pop_ID=NULL, pop_length, pop_weight, size_limits=NULL, outliers = NULL) {
    ...
    which_size_limits <- which(pop_length>=which_size_limits[1] & pop_length<=which_size_limits[2])
...
The function is called ```RelWeight_Fisheries``` and require the following arguments: `r args(RelWeight_Fisheries)`. The argument *size_limits* allows to calculate the factor only for a range of the population (user must enter a vector of 2 values).
