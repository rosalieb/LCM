...
Rp0.1 <- adjust.forcing(Rp0, parameter = "byprey", group = c("AduRoundfish1"), sim.year = 10:80, sim.month = 0,  bymonth = F, value = 5)
# twice the perturbation but only for 2 years
Rp0.2 <- adjust.forcing(Rp0, parameter = "byprey", group = c("AduRoundfish1"), sim.year = 34:36, sim.month = 0,  bymonth = F, value = 10)
# change the parameter among the different possible forcings
names(Rp0$forcing)
Rp0.3 <- adjust.forcing(Rp0, parameter = "bymigrate", group = c("AduRoundfish1"), sim.year = 20:66, sim.month = 0,  bymonth = F, value = 0.1)
...
#adjust.scenario
Rp1.1 <- adjust.scenario(Rsim.scenario = Rp0, parameter = "byprey", group = "AduRoundfish1", groupto = "bymigrate", value = 3)
