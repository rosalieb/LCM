...
station_which_sampled <- data.frame(matrix(nrow = 29, ncol = 11))
colnames(station_which_sampled) <- unique(smelt$Station)
rownames(station_which_sampled) <- unique(sort(smelt$Year))
